...
export class AnonymousTherapyChatsController {
  constructor(
    private readonly anonymousTherapyChatsService: AnonymousTherapyChatsService,
  ) {}
  ...
  create(
    ...
    return this.anonymousTherapyChatsService.create(
  ...
  update(
    ...
    @Body() updateAnonymousTherapyChatDto: UpdateAnonymousTherapyChatDto,
  ) {
    return this.anonymousTherapyChatsService.update(
      id,
      updateAnonymousTherapyChatDto,
    );
  }
